    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className={`absolute -top-24 -right-24 w-96 h-96 rounded-full ${isDarkMode ? 'bg-green-800' : 'bg-green-200'} blur-3xl opacity-20`}></div>
            ...
            <div className="container mx-auto px-4 h-screen flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 lg:gap-12 py-16">
                ...
                <div className={`w-full lg:w-6/12 space-y-6 text-center lg:text-left ${isVisible ? 'animate-fadeIn' : 'opacity-0'}`}>
                    <div className="inline-block px-4 py-1 rounded-full bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 text-sm font-medium mb-2">
                        Digital Innovation Studio
                    </div>
                    
                    <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold leading-tight`}>
                        <span className={isDarkMode ? 'text-white' : 'text-gray-900'}>Innovate, Create</span>{' '}
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className={`${isDarkMode ? 'fill-gray-800' : 'fill-white'} w-full h-12`}>

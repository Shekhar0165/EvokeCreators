...
export default function page() {
    ...
    return (
        <div ref={elementRef} className="min-h-screen relative pt-20">
            {/* Background Pattern */}
            <div className="absolute inset-0 bg-grid-pattern opacity-5" />

            <div className="relative">
                <div className={`${isDarkMode ? 'text-white' : 'text-gray-900'}  relative overflow-hidden`}>
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
                        <div className={`text-center ${isVisible ? 'md:animate-fade-in-up' : 'md:opacity-0'}`}>
                ...
                <div >
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                        <div className="grid lg:grid-cols-2 gap-16 items-start">
                            {/* Contact Information */}
                            <div className={`space-y-8 ${isVisible ? 'md:animate-fade-in-left' : 'md:opacity-0'}`}>
                ...
                <div className="h-64 rounded-lg overflow-hidden shadow-lg my-10 mx-14">
                    <iframe
                        src="https://www.google.com/maps?q=Shri+Hans+Bhakti+Dham+Manav+Dharam+Ashram+Lucknow&output=embed"
